...
def parse_args(pargs=None):
    ...
    parser.add_argument('--data0', default='./data/VOO.csv',
                        required=False, help='Data0 to read in')

    parser.add_argument('--data1', default='./data/BND.csv',
                        required=False, help='Data1 to read in')

    parser.add_argument('--data2', default='./data/VWO.csv',
                        required=False, help='Data2 to read in')

    # Defaults for dates
    parser.add_argument('--fromdate', required=False, default='2015-12-21',
                        help='Date[time] in YYYY-MM-DD[THH:MM:SS] format')

    parser.add_argument('--todate', required=False, default='2020-12-18',
                        help='Date[time] in YYYY-MM-DD[THH:MM:SS] format')
